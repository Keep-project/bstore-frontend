                            ...
                            TextButton(
                              ...
                              child: Padding(
                                ...
                                child: Text(
                                  "Commenter",
                                  style: TextStyle(
                                    color: controller.showComments ? Colors.black : Colors.black.withOpacity(0.5),
                                    fontSize: 16,
                                    fontWeight: FontWeight.w600,
                                  ),
                                ),
                          ...
                          Row(children: <Widget>[
                            IconButton(
                                ...
                                icon: Icon(CupertinoIcons.chevron_left,
                                    color: controller.currentIndexPage == 0  ? kOrangeColor.withOpacity(.4) : kOrangeColor, size: 20)),
                            IconButton(
                                onPressed: () {
